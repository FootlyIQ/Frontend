...
export default function Fantasy() {
  ...
  return (
    <div className="flex flex-col lg:flex-row min-h-screen bg-slate-900 text-gray-100">
      <main className="flex-1 p-6">
        <div className="flex flex-col lg:flex-row gap-6">
          
          {/* Left Panel (Suggestions + Search) */}
          <div className="lg:w-1/3 w-full bg-gray-800 p-4 rounded-lg shadow">
          ...
          <div className="lg:w-1/3 w-full bg-gray-100 dark:bg-gray-800 p-4 rounded-lg shadow">
            ...
            <div className="mb-4">
              <input
                ...
                className="w-full px-4 py-2 rounded-lg border border-gray-600 bg-gray-700 text-gray-100 focus:outline-none focus:ring-2 focus:ring-emerald-400"
          {/* Left Panel */}
          <div className="lg:w-1/3 w-full bg-gray-100 dark:bg-gray-800 p-4 rounded-lg shadow">
            <h2 className="text-xl font-semibold mb-4">Fantasy FPL Team</h2>
            ...
            <ul className="space-y-2">
              {["Erling Haaland", "Bukayo Saka", "Jude Bellingham"].map((name, idx) => (
                <li
                  key={idx}
                  className="bg-gray-700 p-3 rounded-lg shadow-sm hover:bg-emerald-50 cursor-pointer transition"
                >
                  {name}
                </li>
              ))}
          ...
          {/* Right Panel (Pitch) */}
          <div className="lg:w-2/3 w-full bg-green-600 p-6 rounded-lg shadow flex items-center justify-center">
